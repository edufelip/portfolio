...
export async function getStaticProps({ locale }) {
  ...
  let about_desc_two = locale == "en-US" ? "I first started coding in 2017 and besides my initial experience being in web development, what indeed captivated me was mobile development with Java and Kotlin, and since then one of my biggest priorities has been about building applications with clean, readable and maintainable code." : "Eu comecei a programar em 2017 e, apesar da minha experiência inicial ser em desenvolvimento para web, o que me cativou mesmo foi o desenvolvimento mobile com Java e Kotlin, e desde então uma das minhas maiores prioridades tem sido construir aplicativos com código limpo, legível e eficiente."
