        ...
        <SupportCard>
          <SupportBody>
            <PrivacyPolicyBody className="support_body">
              ...
              <p>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Amazing Note is a Compose Multiplatform note-taking
                app. This page provides support information and ways to get help with the app.
              </p>
              <h2>Contact</h2>
              <p>
              ...
              <h2>Last Updated</h2>
              <p className="support_meta">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;January 7, 2026</p>
            </PrivacyPolicyBody>
          </SupportBody>
        </SupportCard>
      </SupportPage>
