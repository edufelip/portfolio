    ...
    <div>
      ...
      <main>
        <PrivacyPolicyBody>
          ...
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Eduardo Santos built the <b>Finn</b> app as an Open Source
            app. This SERVICE is provided by Eduardo Santos at no cost and is intended for use as
            is. This page is used to inform visitors regarding my policies with the collection, use,
            and disclosure of Personal Information if anyone decided to use my Service. If you
            ...
            meanings as in our Terms and Conditions, which are accessible at Finn unless otherwise
          ...
          <div className="bulletcontainer">
            <p>
              ...
              but not limited to name,email. The information that I request will be retained on your
              device and is not collected by me in any way. The app does use third-party services
              that may collect information used to identify you. Link to the privacy policy of
          ...
          <p>
            ...
            commonly used as anonymous unique identifiers. These are sent to your browser from the
            websites that you visit and are stored on your device&#39;s internal memory. This
